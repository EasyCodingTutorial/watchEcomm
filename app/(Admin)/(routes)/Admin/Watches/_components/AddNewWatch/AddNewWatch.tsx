...
interface DropDownWatchStokeProp {
    value: string,
    label: string,
}


export const AddNewWatch = () => {
    ...
    const handleAddNewWatch: React.FormEventHandler<HTMLFormElement> = async (
        e
    ) => {
        e.preventDefault();
    ...
    return (
        <div className={styles.AddNewWatch}>
            <div className={styles.Row}>
                <h2>Add New Watch</h2>
                <form onSubmit={handleAddNewWatch}>
                                    ...
                                    watchImgUrl && (
                                        <div className={styles.ImgContentUploadThing}>
                                            <Link href={watchImgUrl} target="_blank">
                                                <img src={watchImgUrl} alt="" loading="lazy" />
                                            </Link>
                                        </div>
                                    )
                                }
